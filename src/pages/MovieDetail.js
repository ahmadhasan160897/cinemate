...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=7ce2923c729845641f2c1d32366f6d3b`);
...
<div className="flex items-center">
  ...
  <p className="my-4">
    ...
    <Link to={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferer" >{movie.imdb_id}</Link>
  </p>
      </div>
    </section>
   </main>
